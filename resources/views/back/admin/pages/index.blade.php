@extends('back.student.layouts.layout')
                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">
                                        Yeni bilgiler edin kendini geliştir, hayat tarzın değişsin!
                                    </p>

                                    <a href="javascript:;" class="btn btn-sm btn-outline-primary">Kurs İzle</a>
                                </div>
                            </div>
